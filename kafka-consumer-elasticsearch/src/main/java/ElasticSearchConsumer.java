...
/*
        String username = "elastic"; // needed only for bonsai
        String password = "changeme"; // needed only for bonsai
*/
...
*/
    ...
    public static void main(String[] args) throws IOException {
        ...
        RestHighLevelClient client = createClient();
            ...
            IndexRequest indexRequest= new IndexRequest("twitter","type").source(jsonObject,XContentType.JSON);
